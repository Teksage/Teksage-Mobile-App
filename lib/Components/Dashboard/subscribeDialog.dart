...
class _SubscribePromptDialogState extends State<SubscribePromptDialog> {
  ...
  /// Resolved INR/USD — never null after [_load] finishes.
  String resolvedCurrency = 'INR';

  bool get isINR => resolvedCurrency == 'INR';
  ...
  Future<void> _load() async {
    await _resolveCurrency();
    await fetchPlans();
  }

  Future<void> _resolveCurrency() async {
    final passed = widget.currency?.trim();
    if (passed != null && passed.isNotEmpty) {
      resolvedCurrency = passed;
      return;
    }
    try {
      resolvedCurrency = await ProfileCurrency.resolve();
    } catch (_) {
                        ...
                        : Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: List.generate(premiumPlans.length,
                                    (index) {
