...
class LocalString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ta': {
          ...
          'Enable WhatsApp Astrology Alerts': 'WhatsApp ஜோதிட எச்சரிக்கைகளை இயக்கவும்',
          ...
          'Use my verified profile number': 'எனது சரிபார்க்கப்பட்ட சுயவிவர எண்ணைப் பயன்படுத்தவும்',
          'Use a different WhatsApp number': 'வேறு WhatsApp எண்ணைப் பயன்படுத்தவும்',
          ...
          'We will match you with an astrologer who speaks your language.': 'உங்கள் மொழியில் பேசும் ஒரு ஜோதிடரை நாங்கள் உங்களுக்குப் பொருத்துவோம்.',
          'Please select a language': 'தயவுசெய்து ஒரு மொழியைத் தேர்ந்தெடுக்கவும்',
          'Notes': 'குறிப்புகள்',
          'Your answer will be delivered within 4 hours.': 'உங்கள் பதில் 4 மணி நேரத்தில் வழங்கப்படும்.',
          'An expert astrologer will review your question and horoscope, then reply with a personalized voice message.': 'ஒரு நிபுணர் ஜோதிடர் உங்கள் கேள்வியையும் ஜாதகத்தையும் ஆய்வு செய்து, தனிப்பயன் குரல் செய்தியில் பதிலளிப்பார்.',
          'You can view your answer anytime under Notifications → Consultation.': 'உங்கள் பதிலை எப்போதும் அறிவிப்புகள் → ஆலோசனையில் பார்க்கலாம்.',
          ...
          'Could not load pricing. Please try again.': 'கட்டண விவரங்களை ஏற்ற முடியவில்லை. மீண்டும் முயற்சிக்கவும்.',
          'Could not initiate payment. Please try again.': 'கட்டணத்தைத் தொடங்க முடியவில்லை. மீண்டும் முயற்சிக்கவும்.',
          'Verification failed. Please contact support.': 'சரிபார்ப்பு தோல்வியடைந்தது. ஆதரவை தொடர்பு கொள்ளவும்.',
          'Get Updates on WhatsApp': 'WhatsApp-ல் புதுப்பிப்புகளைப் பெறுங்கள்',
          'WhatsApp notifications': 'WhatsApp அறிவிப்புகள்',
          'Enable WhatsApp status updates': 'WhatsApp நிலை புதுப்பிப்புகளை இயக்கவும்',
          'We\'ll send a confirmation message to your WhatsApp. Reply to opt in for alerts.': 'உங்கள் WhatsApp-க்கு ஒரு உறுதிப்படுத்தல் செய்தியை அனுப்புவோம். எச்சரிக்கைகளுக்கு சேர பதிலளிக்கவும்.',
          'Alert when your astrologer\'s answer is ready': 'உங்கள் ஜோதிடரின் பதில் தயாரானபோது எச்சரிக்கை',
          'Updates when your request status changes': 'உங்கள் கோரிக்கையின் நிலை மாறும்போது புதுப்பிப்புகள்',
          'Skip for now': 'இப்போது தவிர்க்கவும்',
          'You are all set!': 'நீங்கள் தயாராக இருக்கிறீர்கள்!',
          'Your question is with our team. An expert astrologer will answer within 4 hours.': 'உங்கள் கேள்வி எங்கள் குழுவிடம் உள்ளது. 4 மணி நேரத்தில் ஒரு நிபுணர் ஜோதிடர் பதிலளிப்பார்.',
          'Status': 'நிலை',
          'Received': 'பெறப்பட்டது',
          'Track in Notifications → Consultation': 'அறிவிப்புகள் → ஆலோசனையில் கண்காணிக்கவும்',
          ...
          'An astrologer has replied to your question.': 'ஒரு ஜோதிடர் உங்கள் கேள்விக்கு பதிலளித்துள்ளார்.',
          'Read or listen to the answer now — or find it later in Notifications.': 'இப்போது பதிலை படிக்கவும் அல்லது கேளுங்கள் — அல்லது பின்னர் அறிவிப்புகளில் காணவும்.',
          'Open answer': 'பதிலைத் திறக்கவும்',
          'Not now': 'இப்போது வேண்டாம்',
          'No Ask Astrologer requests yet.': 'இன்னும் ஜோதிடர் கேள்விகள் எதுவும் இல்லை.',
        ...
        'te_IN': {
          ...
          'Enable WhatsApp Astrology Alerts': 'WhatsApp జ్యోతిష్య అలర్ట్‌లను ఎనేబుల్ చేయండి',
          ...
          'Use my verified profile number': 'నా ధృవీకరించిన ప్రొఫైల్ నంబర్‌ను ఉపయోగించండి',
          'Use a different WhatsApp number': 'వేరే WhatsApp నంబర్‌ను ఉపయోగించండి',
          'Enter a valid mobile number.': 'చెల్లుబాటు అయ్యే మొబైల్ నంబర్‌ను నమోదు చేయండి.',
          'Sent to': 'పంపబడింది',
          ...
          'We will match you with an astrologer who speaks your language.': 'మీ భాష మాట్లాడే జ్యోతిష్కుడిని మీతో జోడిస్తాం.',
          'Please select a language': 'దయచేసి ఒక భాషను ఎంచుకోండి',
          'Notes': 'గమనికలు',
          'Your answer will be delivered within 4 hours.': 'మీ సమాధానం 4 గంటలలోపు అందుతుంది.',
          'An expert astrologer will review your question and horoscope, then reply with a personalized voice message.': 'ఒక నిపుణ జ్యోతిష్కుడు మీ ప్రశ్న మరియు జాతకాన్ని సమీక్షించి, వ్యక్తిగత వాయిస్ మెసేజ్ ద్వారా సమాధానమిస్తారు.',
          'You can view your answer anytime under Notifications → Consultation.': 'మీ సమాధానాన్ని ఎప్పుడైనా నోటిఫికేషన్లు → కన్సల్టేషన్ లో చూడవచ్చు.',
          ...
          'Could not load pricing. Please try again.': 'ధర వివరాలు లోడ్ కాలేదు. మళ్ళీ ప్రయత్నించండి.',
          'Could not initiate payment. Please try again.': 'చెల్లింపు ప్రారంభించలేకపోయాం. మళ్ళీ ప్రయత్నించండి.',
          'Verification failed. Please contact support.': 'ధృవీకరణ విఫలమైంది. సపోర్ట్‌ని సంప్రదించండి.',
          'Get Updates on WhatsApp': 'WhatsApp లో అప్‌డేట్‌లు పొందండి',
          'WhatsApp notifications': 'WhatsApp నోటిఫికేషన్లు',
          'Enable WhatsApp status updates': 'WhatsApp స్టేటస్ అప్‌డేట్‌లు ఎనేబుల్ చేయండి',
          'We\'ll send a confirmation message to your WhatsApp. Reply to opt in for alerts.': 'మేము మీ WhatsApp కి నిర్ధారణ సందేశం పంపుతాం. అలర్ట్‌లకు నమోదు అవ్వడానికి జవాబివ్వండి.',
          'Alert when your astrologer\'s answer is ready': 'జ్యోతిష్కుడి సమాధానం సిద్ధమైనప్పుడు అలర్ట్',
          'Updates when your request status changes': 'మీ అభ్యర్థన స్థితి మారినప్పుడు అప్‌డేట్‌లు',
          'Skip for now': 'ఇప్పుడు వదిలేయండి',
          'You are all set!': 'మీరు సిద్ధంగా ఉన్నారు!',
          'Your question is with our team. An expert astrologer will answer within 4 hours.': 'మీ ప్రశ్న మా టీమ్ దగ్గర ఉంది. 4 గంటల్లో ఒక నిపుణ జ్యోతిష్కుడు సమాధానమిస్తారు.',
          'Status': 'స్థితి',
          'Received': 'స్వీకరించారు',
          'Track in Notifications → Consultation': 'నోటిఫికేషన్లు → కన్సల్టేషన్ లో ట్రాక్ చేయండి',
          ...
          'An astrologer has replied to your question.': 'ఒక జ్యోతిష్కుడు మీ ప్రశ్నకు సమాధానమిచ్చారు.',
          'Read or listen to the answer now — or find it later in Notifications.': 'ఇప్పుడు సమాధానం చదవండి లేదా వినండి — లేదా తర్వాత నోటిఫికేషన్లలో కనుగొనండి.',
        ...
        'kn_IN': {
          ...
          'Enable WhatsApp Astrology Alerts': 'WhatsApp ಜ್ಯೋತಿಷ್ಯ ಅಲರ್ಟ್‌ಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ',
          ...
          'Use my verified profile number': 'ನನ್ನ ಪರಿಶೀಲಿಸಿದ ಪ್ರೊಫೈಲ್ ಸಂಖ್ಯೆಯನ್ನು ಬಳಸಿ',
          'Use a different WhatsApp number': 'ಬೇರೆ WhatsApp ಸಂಖ್ಯೆಯನ್ನು ಬಳಸಿ',
          'Enter a valid mobile number.': 'ಮಾನ್ಯವಾದ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸಿ.',
          ...
          'We will match you with an astrologer who speaks your language.': 'ನಿಮ್ಮ ಭಾಷೆ ಮಾತನಾಡುವ ಜ್ಯೋತಿಷಿಯನ್ನು ನಿಮ್ಮೊಂದಿಗೆ ಹೊಂದಿಸುತ್ತೇವೆ.',
          'Please select a language': 'ದಯವಿಟ್ಟು ಒಂದು ಭಾಷೆ ಆಯ್ಕೆಮಾಡಿ',
          'Notes': 'ಟಿಪ್ಪಣಿಗಳು',
          'Your answer will be delivered within 4 hours.': 'ನಿಮ್ಮ ಉತ್ತರ 4 ಗಂಟೆಗಳಲ್ಲಿ ನೀಡಲಾಗುತ್ತದೆ.',
          'An expert astrologer will review your question and horoscope, then reply with a personalized voice message.': 'ಒಬ್ಬ ತಜ್ಞ ಜ್ಯೋತಿಷಿ ನಿಮ್ಮ ಪ್ರಶ್ನೆ ಮತ್ತು ಜಾತಕವನ್ನು ಪರಿಶೀಲಿಸಿ, ವ್ಯಕ್ತಿಗತ ಧ್ವನಿ ಸಂದೇಶದಲ್ಲಿ ಉತ್ತರಿಸುತ್ತಾರೆ.',
          'You can view your answer anytime under Notifications → Consultation.': 'ನಿಮ್ಮ ಉತ್ತರವನ್ನು ಯಾವಾಗಲಾದರೂ ಅಧಿಸೂಚನೆಗಳು → ಸಲಹೆ ಅಡಿಯಲ್ಲಿ ನೋಡಬಹುದು.',
          ...
          'Could not load pricing. Please try again.': 'ಬೆಲೆ ವಿವರಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗಲಿಲ್ಲ. ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
          'Could not initiate payment. Please try again.': 'ಪಾವತಿ ಪ್ರಾರಂಭಿಸಲಾಗಲಿಲ್ಲ. ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
          'Verification failed. Please contact support.': 'ಪರಿಶೀಲನೆ ವಿಫಲವಾಗಿದೆ. ಸಹಾಯ ತಂಡವನ್ನು ಸಂಪರ್ಕಿಸಿ.',
          'Get Updates on WhatsApp': 'WhatsApp ನಲ್ಲಿ ಅಪ್‌ಡೇಟ್‌ಗಳನ್ನು ಪಡೆಯಿರಿ',
          'WhatsApp notifications': 'WhatsApp ಅಧಿಸೂಚನೆಗಳು',
          'Enable WhatsApp status updates': 'WhatsApp ಸ್ಟೇಟಸ್ ಅಪ್‌ಡೇಟ್‌ಗಳನ್ನು ಸಕ್ರಿಯಗೊಳಿಸಿ',
          'We\'ll send a confirmation message to your WhatsApp. Reply to opt in for alerts.': 'ನಿಮ್ಮ WhatsApp ಗೆ ಒಂದು ದೃಢೀಕರಣ ಸಂದೇಶ ಕಳುಹಿಸುತ್ತೇವೆ. ಎಚ್ಚರಿಕೆಗಳಿಗೆ ನೋಂದಾಯಿಸಲು ಉತ್ತರಿಸಿ.',
          'Alert when your astrologer\'s answer is ready': 'ಜ್ಯೋತಿಷಿ ಉತ್ತರ ಸಿದ್ಧವಾದಾಗ ಎಚ್ಚರಿಕೆ',
          'Updates when your request status changes': 'ನಿಮ್ಮ ವಿನಂತಿ ಸ್ಥಿತಿ ಬದಲಾದಾಗ ಅಪ್‌ಡೇಟ್‌ಗಳು',
          'Skip for now': 'ಈಗ ತಪ್ಪಿಸಿಕೊಳ್ಳಿ',
          'You are all set!': 'ನೀವು ಸಿದ್ಧರಾಗಿದ್ದೀರಿ!',
          'Your question is with our team. An expert astrologer will answer within 4 hours.': 'ನಿಮ್ಮ ಪ್ರಶ್ನೆ ನಮ್ಮ ತಂಡದ ಬಳಿ ಇದೆ. 4 ಗಂಟೆಗಳಲ್ಲಿ ತಜ್ಞ ಜ್ಯೋತಿಷಿ ಉತ್ತರಿಸುತ್ತಾರೆ.',
          'Status': 'ಸ್ಥಿತಿ',
          'Received': 'ಸ್ವೀಕರಿಸಲಾಗಿದೆ',
          'Track in Notifications → Consultation': 'ಅಧಿಸೂಚನೆಗಳು → ಸಲಹೆ ಯಲ್ಲಿ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ',
          ...
          'An astrologer has replied to your question.': 'ಒಬ್ಬ ಜ್ಯೋತಿಷಿ ನಿಮ್ಮ ಪ್ರಶ್ನೆಗೆ ಉತ್ತರಿಸಿದ್ದಾರೆ.',
          'Read or listen to the answer now — or find it later in Notifications.': 'ಈಗ ಉತ್ತರ ಓದಿ ಅಥವಾ ಕೇಳಿ — ಅಥವಾ ನಂತರ ಅಧಿಸೂಚನೆಗಳಲ್ಲಿ ಕಂಡುಕೊಳ್ಳಿ.',
        ...
        'ml_IN': {
          ...
          'Enable WhatsApp Astrology Alerts': 'WhatsApp ജ്യോതിഷ അലേർട്ടുകൾ പ്രവർത്തനക്ഷമമാക്കൂ',
          ...
          'Use my verified profile number': 'എന്റെ സ്ഥിരീകരിച്ച പ്രൊഫൈൽ നമ്പർ ഉപയോഗിക്കൂ',
          'Use a different WhatsApp number': 'മറ്റൊരു WhatsApp നമ്പർ ഉപയോഗിക്കൂ',
          ...
          'Select your preferred language': 'നിങ്ങൾ ഇഷ്ടപ്പെടുന്ന ഭാഷ തിരഞ്ഞെടുക്കൂ',
          'We will match you with an astrologer who speaks your language.': 'നിങ്ങളുടെ ഭാഷ സംസാരിക്കുന്ന ഒരു ജ്യോതിഷിയെ ഞങ്ങൾ കണ്ടെത്തി തരും.',
          'Please select a language': 'ദയവായി ഒരു ഭാഷ തിരഞ്ഞെടുക്കൂ',
          'Notes': 'കുറിപ്പുകൾ',
          'Your answer will be delivered within 4 hours.': 'നിങ്ങളുടെ ഉത്തരം 4 മണിക്കൂറിനുള്ളിൽ ലഭിക്കും.',
          'An expert astrologer will review your question and horoscope, then reply with a personalized voice message.': 'ഒരു വിദഗ്ധ ജ്യോതിഷി നിങ്ങളുടെ ചോദ്യവും ജാതകവും അവലോകനം ചെയ്ത്, വ്യക്തിഗത വോയ്‌സ് മെസ്സേജ് ഉപയോഗിച്ച് മറുപടി നൽകും.',
          'You can view your answer anytime under Notifications → Consultation.': 'നിങ്ങളുടെ ഉത്തരം ഏത് സമയത്തും നോട്ടിഫിക്കേഷനുകൾ → കൺസൾട്ടേഷൻ ൽ കാണാം.',
          ...
          'Could not load pricing. Please try again.': 'വില വിവരങ്ങൾ ലോഡ് ചെയ്യാനായില്ല. വീണ്ടും ശ്രമിക്കൂ.',
          'Could not initiate payment. Please try again.': 'പേയ്‌മെന്റ് ആരംഭിക്കാനായില്ല. വീണ്ടും ശ്രമിക്കൂ.',
          'Verification failed. Please contact support.': 'സ്ഥിരീകരണം പരാജയപ്പെട്ടു. സപ്പോർട്ടിനെ ബന്ധപ്പെടൂ.',
          'Get Updates on WhatsApp': 'WhatsApp ൽ അപ്‌ഡേറ്റ് നേടൂ',
          'WhatsApp notifications': 'WhatsApp അറിയിപ്പുകൾ',
          'Enable WhatsApp status updates': 'WhatsApp സ്റ്റേറ്റസ് അപ്‌ഡേറ്റ് പ്രവർത്തനക്ഷമമാക്കൂ',
          'We\'ll send a confirmation message to your WhatsApp. Reply to opt in for alerts.': 'ഞങ്ങൾ നിങ്ങളുടെ WhatsApp ലേക്ക് ഒരു സ്ഥിരീകരണ സന്ദേശം അയക്കും. അലേർട്ടുകൾക്ക് ഓപ്റ്റ് ഇൻ ചെയ്യാൻ മറുപടി നൽകൂ.',
          'Alert when your astrologer\'s answer is ready': 'ജ്യോതിഷിയുടെ ഉത്തരം തയ്യാറാകുമ്പോൾ അലേർട്ട്',
          'Updates when your request status changes': 'നിങ്ങളുടെ അഭ്യർഥനയുടെ നില മാറുമ്പോൾ അപ്‌ഡേറ്റ്',
          'Skip for now': 'ഇപ്പോൾ ഒഴിവാക്കുക',
          'You are all set!': 'നിങ്ങൾ തയ്യാറാണ്!',
          'Your question is with our team. An expert astrologer will answer within 4 hours.': 'നിങ്ങളുടെ ചോദ്യം ഞങ്ങളുടെ ടീമിന്റെ അടുത്തുണ്ട്. 4 മണിക്കൂറിനുള്ളിൽ ഒരു വിദഗ്ധ ജ്യോതിഷി ഉത്തരം നൽകും.',
          'Status': 'നില',
          'Received': 'ലഭിച്ചു',
          'Track in Notifications → Consultation': 'നോട്ടിഫിക്കേഷനുകൾ → കൺസൾട്ടേഷൻ ൽ ട്രാക്ക് ചെയ്യൂ',
          ...
          'An astrologer has replied to your question.': 'ഒരു ജ്യോതിഷി നിങ്ങളുടെ ചോദ്യത്തിന് ഉത്തരം നൽകിയിട്ടുണ്ട്.',
          'Read or listen to the answer now — or find it later in Notifications.': 'ഇപ്പോൾ ഉത്തരം വായിക്കൂ അല്ലെങ്കിൽ കേൾക്കൂ — അല്ലെങ്കിൽ പിന്നീട് നോട്ടിഫിക്കേഷനുകളിൽ കണ്ടെത്തൂ.',
          'Open answer': 'ഉത്തരം തുറക്കൂ',
          'Not now': 'ഇപ്പോൾ വേണ്ട',
          'No Ask Astrologer requests yet.': 'ഇനിയും ജ്യോതിഷ ചോദ്യങ്ങൾ ഒന്നുമില്ല.',
        ...
        'hi': {
          ...
          'Enable WhatsApp Astrology Alerts': 'WhatsApp ज्योतिष अलर्ट सक्षम करें',
          ...
          'Use my verified profile number': 'मेरा सत्यापित प्रोफ़ाइल नंबर उपयोग करें',
          ...
          'We will match you with an astrologer who speaks your language.': 'हम आपको आपकी भाषा बोलने वाले ज्योतिषी से मिलाएंगे।',
          'Please select a language': 'कृपया एक भाषा चुनें',
          'Notes': 'नोट्स',
          'Your answer will be delivered within 4 hours.': 'आपका उत्तर 4 घंटों के भीतर दिया जाएगा।',
          'An expert astrologer will review your question and horoscope, then reply with a personalized voice message.': 'एक विशेषज्ञ ज्योतिषी आपके प्रश्न और जन्मपत्री की समीक्षा करेंगे, फिर एक व्यक्तिगत आवाज संदेश के साथ जवाब देंगे।',
          'You can view your answer anytime under Notifications → Consultation.': 'आप अपना उत्तर कभी भी सूचनाएं → परामर्श में देख सकते हैं।',
          ...
          'Could not load pricing. Please try again.': 'मूल्य निर्धारण लोड नहीं हो सका। कृपया पुनः प्रयास करें।',
          'Could not initiate payment. Please try again.': 'भुगतान शुरू नहीं हो सका। कृपया पुनः प्रयास करें।',
          'Verification failed. Please contact support.': 'सत्यापन विफल हुआ। कृपया सहायता से संपर्क करें।',
          ...
          'We\'ll send a confirmation message to your WhatsApp. Reply to opt in for alerts.': 'हम आपके WhatsApp पर एक पुष्टि संदेश भेजेंगे। अलर्ट के लिए ऑप्ट इन करने हेतु उत्तर दें।',
          'Alert when your astrologer\'s answer is ready': 'जब आपके ज्योतिषी का उत्तर तैयार हो तो सूचना',
          'Updates when your request status changes': 'अनुरोध की स्थिति बदलने पर अपडेट',
          'Skip for now': 'अभी छोड़ें',
          'You are all set!': 'आप तैयार हैं!',
          'Your question is with our team. An expert astrologer will answer within 4 hours.': 'आपका प्रश्न हमारी टीम के पास है। 4 घंटों में एक विशेषज्ञ ज्योतिषी जवाब देंगे।',
          'Status': 'स्थिति',
          'Received': 'प्राप्त',
          'Track in Notifications → Consultation': 'सूचनाएं → परामर्श में ट्रैक करें',
          'Back to Chat': 'Chat पर वापस जाएं',
          'Back to Event Planner': 'Event Planner पर वापस जाएं',
          'Your answer is ready': 'आपका उत्तर तैयार है',
          'An astrologer has replied to your question.': 'एक ज्योतिषी ने आपके प्रश्न का उत्तर दिया है।',
          'Read or listen to the answer now — or find it later in Notifications.': 'अभी उत्तर पढ़ें या सुनें — या बाद में सूचनाओं में खोजें।',
        ...
        'mr_IN': {
          ...
          'Enable WhatsApp Astrology Alerts': 'WhatsApp ज्योतिष अलर्ट सक्षम करा',
          ...
          'We will match you with an astrologer who speaks your language.': 'आम्ही तुम्हाला तुमची भाषा बोलणाऱ्या ज्योतिषाशी जोडू.',
          'Please select a language': 'कृपया एक भाषा निवडा',
          'Notes': 'नोट्स',
          'Your answer will be delivered within 4 hours.': 'तुमचे उत्तर ४ तासांत मिळेल.',
          'An expert astrologer will review your question and horoscope, then reply with a personalized voice message.': 'एक तज्ञ ज्योतिष तुमचा प्रश्न आणि जन्मपत्रिका तपासून वैयक्तिक व्हॉइस संदेशाने उत्तर देतील.',
          'You can view your answer anytime under Notifications → Consultation.': 'तुम्ही तुमचे उत्तर केव्हाही सूचना → सल्लामसलत मध्ये पाहू शकता.',
          ...
          'Could not load pricing. Please try again.': 'किंमत माहिती लोड करता आली नाही. पुन्हा प्रयत्न करा.',
          'Could not initiate payment. Please try again.': 'पेमेंट सुरू करता आले नाही. पुन्हा प्रयत्न करा.',
          'Verification failed. Please contact support.': 'पडताळणी अयशस्वी. कृपया सपोर्टशी संपर्क साधा.',
          ...
          'We\'ll send a confirmation message to your WhatsApp. Reply to opt in for alerts.': 'आम्ही तुमच्या WhatsApp वर एक पुष्टी संदेश पाठवू. अलर्टसाठी नोंदणी करण्यासाठी उत्तर द्या.',
          'Alert when your astrologer\'s answer is ready': 'ज्योतिषाचे उत्तर तयार झाल्यावर सूचना',
          'Updates when your request status changes': 'विनंतीची स्थिती बदलल्यावर अपडेट्स',
          'Skip for now': 'आत्ता वगळा',
          'You are all set!': 'तुम्ही तयार आहात!',
          'Your question is with our team. An expert astrologer will answer within 4 hours.': 'तुमचा प्रश्न आमच्या टीमकडे आहे. ४ तासांत एक तज्ञ ज्योतिष उत्तर देतील.',
          'Status': 'स्थिती',
          'Received': 'प्राप्त',
          'Track in Notifications → Consultation': 'सूचना → सल्लामसलत मध्ये ट्रॅक करा',
          'Back to Chat': 'Chat वर परत जा',
          'Back to Event Planner': 'Event Planner वर परत जा',
          'Your answer is ready': 'तुमचे उत्तर तयार आहे',
          'An astrologer has replied to your question.': 'एका ज्योतिषाने तुमच्या प्रश्नाचे उत्तर दिले आहे.',
          'Read or listen to the answer now — or find it later in Notifications.': 'आत्ता उत्तर वाचा किंवा ऐका — किंवा नंतर सूचनांमध्ये शोधा.',
          'Open answer': 'उत्तर उघडा',
          'Not now': 'आत्ता नाही',
          'No Ask Astrologer requests yet.': 'अजून कोणतेही ज्योतिष प्रश्न नाहीत.',
